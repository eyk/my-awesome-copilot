...
Collection and development repository for GitHub Copilot skills: examples, templates, tests, and documentation.
...
- `.github/`: CI workflows, issue/PR templates, and contributor instructions
- `.vscode/`: Recommendations for using this workspace
